...
![](fig/episode_5_Table.png){alt='Example for the knowledge graph spanned by one Wikidata item and more details about Feynman'}
...
![](fig/episode_5_defaultview.png){alt='Example for the knowledge graph spanned by one Wikidata item and more details about Feynman'}
### Exercises
